...
export const importSelectiveConversations = () => `${conversationsRoot}/import-selective`;
...
export const modelRates = () => `${BASE_URL}/api/models/rates`;
...
// Admin Stats
export const adminStats = (days?: number) =>
  `${BASE_URL}/api/admin/stats${days ? `?days=${days}` : ''}`;
