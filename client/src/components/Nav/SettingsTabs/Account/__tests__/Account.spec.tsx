...
jest.mock('../WeChatBinding', () => () => <div data-testid="wechat-binding" />);
...
describe('Account', () => {
  describe('DeleteAccount visibility', () => {
    ...
    it('hides DeleteAccount when allowAccountDeletion is false for non-admin users', () => {
    ...
    it('shows DeleteAccount for admins even when allowAccountDeletion is false', () => {
