...
function setupMocks(overrides: { provider?: string | null } = {}) {
...
describe('AttachFileMenu', () => {
  ...
  describe('Upload to Provider vs Upload Image', () => {
    ...
    it('prioritizes endpointType over a custom gateway provider name', () => {
      setupMocks({ provider: 'litellm' });
      renderMenu({
        endpoint: 'litellm',
    ...
    it('falls back to current provider when endpointType is undefined', () => {
      setupMocks({ provider: EModelEndpoint.openAI });
      renderMenu({
    ...
    it('falls back to current provider when endpointType is null', () => {
      setupMocks({ provider: EModelEndpoint.anthropic });
      renderMenu({
